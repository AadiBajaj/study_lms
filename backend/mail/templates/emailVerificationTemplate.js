...
const otpTemplate = (otp, name) => {
	...
	<body>
		<div class="container">
			...
			<div class="body">
				<p>Dear ${name}</p>
				<p>Thank you for registering with SkillNesst. To complete your registration, please use the following OTP
			...
			<div class="support">If you have any questions or need assistance, please feel free to reach out to us at <a
					href="mailto:aadi.bajaj1502@gmail.com">aadi.bajaj1502@gmail.com</a>. We are here to help!</div>
		</div>
	</body>
